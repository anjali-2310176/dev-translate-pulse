      ...
      <aside className="sidebar">
        ...
        <div style={{ marginTop: 'auto', padding: '16px 8px' }}>
          {session ? (
            ...
            <button onClick={() => signIn()} style={{ fontSize: '13px', fontWeight: 500, background: 'var(--text-primary)', color: 'var(--bg)', border: 'none', padding: '10px', borderRadius: '6px', cursor: 'pointer', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
              Sign In (Demo Mode)
            </button>
          )}
        </div>
